...
import com.yscope.log4j.tests.memoryConsumption.commonCase.ZstdStreamingFileAppender;
...
public class SocketAppender {
    private static void initializeLog4j2(String appenderName) {
        ...
        AppenderComponentBuilder appenderBuilder = builder.newAppender(appenderName, "Socket");
