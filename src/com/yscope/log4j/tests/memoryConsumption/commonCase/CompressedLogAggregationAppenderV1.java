...
public class CompressedLogAggregationAppenderV1 {
    private static void initializeLog4j2(String appenderName) {
        ...
        builder.setPackages("com.yscope.log4j.appenders.compressedLogAggregationAppender.v1");

        // create console appender
        AppenderComponentBuilder appenderBuilder = builder.newAppender(appenderName, "CompressedLogAggregationV1");
    ...
    public static void main(String[] args) throws InterruptedException {
        String appenderName = "CompressedLogAggregationV1";
        initializeLog4j2(appenderName);

        final Logger logger = LogManager.getLogger(CompressedLogAggregationAppenderV1.class);
