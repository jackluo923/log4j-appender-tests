...
public class GarbageFreeZstdStreamingFileAppender {
    private static void initializeLog4j2(String appenderName) {
        ...
        AppenderComponentBuilder appenderBuilder = builder.newAppender(appenderName, "GarbageFreeZstdStreamingFile");
        appenderBuilder.add(builder.newLayout("PatternLayout")
                .addAttribute("pattern", "%d{HH:mm:ss.SSS} %-5level - %msg%n"));
        appenderBuilder.addAttribute("fileName", "logs/throughputTests/" + appenderName + "/test.zst");
    ...
    public static void main(String[] args) throws InterruptedException {
        String appenderName = "GarbageFreeZstdStreamingFile";
        initializeLog4j2(appenderName);

        final Logger logger = LogManager.getLogger(GarbageFreeZstdStreamingFileAppender.class);
