...
public class CompressedLogAggregationAppenderV4 {
    private static void initializeLog4j2(String appenderName) {
        ...
        builder.setPackages("com.yscope.log4j.appenders.compressedLogAggregationAppender.v4");

        // create console appender
        AppenderComponentBuilder appenderBuilder = builder.newAppender(appenderName, "CompressedLogAggregationV4");
    ...
    public static void main(String[] args) throws InterruptedException {
        String appenderName = "CompressedLogAggregationV4";
        initializeLog4j2(appenderName);

        final Logger logger = LogManager.getLogger(CompressedLogAggregationAppenderV4.class);
