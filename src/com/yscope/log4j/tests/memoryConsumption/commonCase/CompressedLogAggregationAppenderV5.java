...
public class CompressedLogAggregationAppenderV5 {
    private static void initializeLog4j2(String appenderName) {
        ...
        builder.setPackages("com.yscope.log4j.appenders.compressedLogAggregationAppender.v5");

        // create console appender
        AppenderComponentBuilder appenderBuilder = builder.newAppender(appenderName, "CompressedLogAggregationV5");
    ...
    public static void main(String[] args) throws InterruptedException {
        String appenderName = "CompressedLogAggregationV5";
        initializeLog4j2(appenderName);

        final Logger logger = LogManager.getLogger(CompressedLogAggregationAppenderV5.class);
