...
public class GarbageFreeGzipStreamingFileAppender {
    private static void initializeLog4j2(String appenderName) {
        ...
        AppenderComponentBuilder appenderBuilder = builder.newAppender(appenderName, "GarbageFreeGzipStreamingFile");
    ...
    public static void main(String[] args) throws InterruptedException {
        String appenderName = "GarbageFreeGzipStreamingFile";
        initializeLog4j2(appenderName);

        final Logger logger = LogManager.getLogger(GarbageFreeGzipStreamingFileAppender.class);
