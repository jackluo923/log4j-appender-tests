...
public class CompressedLogFileAppenderV5 {
    private static void initializeLog4j2(String appenderName) {
        ...
        builder.setPackages("com.yscope.log4j.appenders.compressedLogFileAppender.v5");

        // create console appender
        AppenderComponentBuilder appenderBuilder = builder.newAppender(appenderName, "CompressedLogFileV5");
    ...
    public static void main(String[] args) throws InterruptedException {
        String appenderName = "CompressedLogFileV5";
        initializeLog4j2(appenderName);

        final Logger logger = LogManager.getLogger(CompressedLogFileAppenderV5.class);
