...
public class CompressedLogAggregationAppenderV3 {
    private static void initializeLog4j2(String appenderName) {
        ...
        builder.setPackages("com.yscope.log4j.appenders.compressedLogAggregationAppender.v3");

        // create console appender
        AppenderComponentBuilder appenderBuilder = builder.newAppender(appenderName, "CompressedLogAggregationV3");
    ...
    public static void main(String[] args) throws InterruptedException {
        String appenderName = "CompressedLogAggregationV3";
        initializeLog4j2(appenderName);

        final Logger logger = LogManager.getLogger(CompressedLogAggregationAppenderV3.class);
