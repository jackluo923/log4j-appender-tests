...
public class CompressedLogFileAppenderV2 {
    private static void initializeLog4j2(String appenderName) {
        ...
        builder.setPackages("com.yscope.log4j.appenders.compressedLogFileAppender.v2");

        // create console appender
        AppenderComponentBuilder appenderBuilder = builder.newAppender(appenderName, "CompressedLogFileV2");
    ...
    public static void main(String[] args) throws InterruptedException {
        String appenderName = "CompressedLogFileV2";
        initializeLog4j2(appenderName);

        final Logger logger = LogManager.getLogger(CompressedLogFileAppenderV2.class);
