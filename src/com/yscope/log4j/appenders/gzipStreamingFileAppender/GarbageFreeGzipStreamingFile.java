 ...
 */
@Plugin(name = GarbageFreeGzipStreamingFile.PLUGIN_NAME, category = Core.CATEGORY_NAME, elementType = Appender.ELEMENT_TYPE, printObject = true)
public final class GarbageFreeGzipStreamingFile extends AbstractAppender {
    public static final String PLUGIN_NAME = "GarbageFreeGzipStreamingFile";
    ...
    private GarbageFreeGzipStreamingFile(String name, Filter filter, Layout<? extends Serializable> layout,
        ...
        try {
            ...
            OutputStream gzOutputStream = new GzipCompressorOutputStream(compressedDataBufferedOutputStream);
            uncompressedDataOutputStream = new BufferedOutputStream(gzOutputStream, 16384);
    ...
    @PluginFactory
    public static GarbageFreeGzipStreamingFile createAppender(
        ...
        return new GarbageFreeGzipStreamingFile(name, filter, layout, fileName, ignoreExceptions);
    }
