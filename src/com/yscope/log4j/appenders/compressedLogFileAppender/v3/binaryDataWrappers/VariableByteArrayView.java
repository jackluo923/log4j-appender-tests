...
/**
 * Variable ByteArray View
 */
public class VariableByteArrayView extends ByteArrayView {
    public long signedLongBackedEncoding;

    public VariableByteArrayView(ByteBuffer variable, int beginPos, int endPos) {
        super(variable.array(), beginPos, endPos);   // Only wrap valid region
    }
     ...
     */
    public boolean encodeAs64bitIntegerType() {
     ...
     * @return false on error, otherwise true
     */
    public boolean encodeAs64bitDecimalType() {
        int pos = beginIndex;
