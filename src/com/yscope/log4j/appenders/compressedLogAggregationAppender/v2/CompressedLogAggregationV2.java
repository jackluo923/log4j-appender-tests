package com.yscope.log4j.appenders.compressedLogAggregationAppender.v2;

import com.yscope.log4j.appenders.compressedLogAggregationAppender.v2.HashMapKey.CompactVariableByteArrayViewDictionaryKey;
import com.yscope.log4j.appenders.compressedLogAggregationAppender.v2.HashMapKey.LogtypeByteArrayViewDictionaryKey;
import com.yscope.log4j.appenders.compressedLogAggregationAppender.v2.HashMapKey.StandardVariableByteArrayViewDictionaryKey;
import com.yscope.log4j.appenders.compressedLogAggregationAppender.v2.HashMapKey.VariableByteArrayViewDictionaryKey;
import com.yscope.log4j.appenders.compressedLogAggregationAppender.v2.intermediateRepresentation.aggregation.CompactAggregationOutputStreamIR;
import com.yscope.log4j.appenders.compressedLogAggregationAppender.v2.intermediateRepresentation.aggregation.StandardAggregationOutputStreamIR;
import com.yscope.log4j.appenders.compressedLogAggregationAppender.v2.intermediateRepresentation.aggregation.BaseAggregationOutputStreamIR;
import com.yscope.log4j.appenders.compressedLogAggregationAppender.v2.utilityClasses.PatternLayoutBufferDestination;
...
/**
 * v2 - Experiment with log aggregation stream appender
 *  - adapted from compressedLogFileAppenderV5 with aggregation data stream sha256 deduplication
 */
@Plugin(name = "CompressedLogAggregationV2", category = Core.CATEGORY_NAME, elementType = Appender.ELEMENT_TYPE, printObject = true)
public final class CompressedLogAggregationV2 extends AbstractAppender {
    ...
    private CompressedLogAggregationV2(String name, Filter filter,
    ...
    @PluginFactory
    public static CompressedLogAggregationV2 createAppender(
        ...
        if (null == name) {
            LOGGER.error("No name provided for " + CompressedLogAggregationV2.class.getName());
            return null;
        }
        if (null == layout) {
        ...
        if (null == fileName) {
            LOGGER.error("No file name provided for " + CompressedLogAggregationV2.class.getName());
            return null;
        }

        return new CompressedLogAggregationV2(name, filter, compressedLogPatternLayoutContainer,
