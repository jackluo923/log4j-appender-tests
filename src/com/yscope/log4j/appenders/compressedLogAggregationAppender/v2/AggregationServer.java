...
import com.yscope.log4j.appenders.compressedLogAggregationAppender.v2.decompressionDictionary.BufferedDataOutputStreamDecompressionDictionary;
import com.yscope.log4j.appenders.compressedLogAggregationAppender.v2.decompressionDictionary.DecompressionDictionary;
...
public class AggregationServer {
    ...
    public static void main(String[] args) throws IOException {
        String fileName = "logs/throughputTests/CompressedLogAggregationV2/test.cla.10.zst";
        ...
        try {
            while (true) {
                ...
                if (operationType == 0x1) {
                    ...
                    logtype.writeInt(logtypeDict.getId(logtypeKey));
                    ...
                    variable.writeInt(variableDict.getCompactId(variableKey));
