 ...
 */
public class CompactVariableByteArrayViewDictionaryKey extends VariableByteArrayViewDictionaryKey {
    private int signedIntBackedEncoding;

    public CompactVariableByteArrayViewDictionaryKey() throws NoSuchAlgorithmException {
        super();
    }

    public int getCompactVariableEncoding() {
        return signedIntBackedEncoding;
    }
