package com.yscope.log4j.appenders.compressedLogAggregationAppender.v4;

import com.yscope.log4j.appenders.compressedLogAggregationAppender.v4.intermediateRepresentation.aggregation.BaseAggregationOutputStreamIR;
...
import com.yscope.log4j.appenders.compressedLogAggregationAppender.v4.HashMapKey.LogtypeByteArrayViewDictionaryKey;
...
import com.yscope.log4j.appenders.compressedLogAggregationAppender.v4.HashMapKey.VariableByteArrayViewDictionaryKey;
import com.yscope.log4j.appenders.compressedLogAggregationAppender.v4.intermediateRepresentation.aggregation.CompactAggregationOutputStreamIR;
import com.yscope.log4j.appenders.compressedLogAggregationAppender.v4.intermediateRepresentation.aggregation.StandardAggregationOutputStreamIR;
import com.yscope.log4j.appenders.compressedLogAggregationAppender.v4.utilityClasses.PatternLayoutBufferDestination;
...
/**
 * v4 - Same as v1, except now we use independent deduplication set for logtype and variable
 *      in BaseAggregationOutputStreamIR class
 *      For some reason, this is slower than v1 and the output stream is a bit larger... doesn't really make sense
 */
@Plugin(name = "CompressedLogAggregationV4", category = Core.CATEGORY_NAME, elementType = Appender.ELEMENT_TYPE, printObject = true)
public final class CompressedLogAggregationV4 extends AbstractAppender {
    ...
    private CompressedLogAggregationV4(String name, Filter filter,
    ...
    @PluginFactory
    public static CompressedLogAggregationV4 createAppender(
        ...
        if (null == name) {
            LOGGER.error("No name provided for " + CompressedLogAggregationV4.class.getName());
            return null;
        }
        if (null == layout) {
        ...
        if (null == fileName) {
            LOGGER.error("No file name provided for " + CompressedLogAggregationV4.class.getName());
            return null;
        }

        return new CompressedLogAggregationV4(name, filter, compressedLogPatternLayoutContainer,
